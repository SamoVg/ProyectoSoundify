...
namespace ProyectoSoundify.Migrations
{
    ...
    [Migration("20231125020859_CorreccionSizeRutaImgAnuncio")]
    partial class CorreccionSizeRutaImgAnuncio
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Anuncio", b =>
                {
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Cancion", b =>
                {
                    b.Property<int>("IdCancion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Categorium", b =>
                {
                    b.Property<int>("IdCategoria")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Descarga", b =>
                {
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Playlist", b =>
                {
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.PlaylistCancion", b =>
                {
                    b.Property<int>("IdPlaylist")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Reproduccion", b =>
                {
            ...
            modelBuilder.Entity("MeGustum", b =>
                {
                    b.HasOne("ProyectoSoundify.Models.dbModels.Cancion", null)
                        .WithMany()
                        .HasForeignKey("IdCancion")
                        .IsRequired()
                        .HasConstraintName("FK_Cancion");

                    b.HasOne("ProyectoSoundify.Models.dbModels.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Anuncio", b =>
                {
                    b.HasOne("ProyectoSoundify.Models.dbModels.ApplicationUser", "IdUsuarioNavigation")
                        .WithMany("Anuncios")
                        .HasForeignKey("IdUsuario")
                        .IsRequired()
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Cancion", b =>
                {
                    b.HasOne("ProyectoSoundify.Models.dbModels.Categorium", "IdCategoriaNavigation")
                        .WithMany("Cancions")
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.Descarga", b =>
                {
                    b.HasOne("ProyectoSoundify.Models.dbModels.Cancion", "IdCancionNavigation")
                        .WithMany("Descargas")
                        .HasForeignKey("IdCancion")
                        .IsRequired()
                        .HasConstraintName("FK_IdCancionDescarga");

                    b.HasOne("ProyectoSoundify.Models.dbModels.ApplicationUser", "IdUserNavigation")
                        .WithMany("Descargas")
            ...
            modelBuilder.Entity("ProyectoSoundify.Models.dbModels.PlaylistCancion", b =>
                {
                    ...
                    b.HasOne("ProyectoSoundify.Models.dbModels.Playlist", "IdPlaylistNavigation")
                        .WithMany("PlaylistCancions")
